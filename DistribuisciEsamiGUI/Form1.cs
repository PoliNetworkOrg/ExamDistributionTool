    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (r == DialogResult.OK)
            {
                ...
                esami = new DistribuisciEsamiCommon.Esami(file);
                ...
                if (rispostaCompleta.Item1 != null)
                {
                    ...
                    foreach (List<int> p in rispostaCompleta.Item1.punteggi.rank)
                    {
                        foreach (var p2 in p)
                        {
                            textBox1.Text += (rispostaCompleta.Item1.soluzioni[p2].ToConsoleOutput(esami));
                            textBox1.Text += (rispostaCompleta.Item1.soluzioni[p2].value);
                            textBox1.Text += ("\n");
                        }
